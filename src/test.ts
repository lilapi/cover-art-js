...
import { littleEagleImagesURL, gitHubTemplateURL } from "./index";
...
test("gitHubTemplateURL()", () => {
  assert.is(
    ...
    "https://cdn.littleeagle.io/1/github/BurntCaramel?t1=First&t1-size=17&t1-color=%23aaa&bg-color=%2300b4ff",
  );
